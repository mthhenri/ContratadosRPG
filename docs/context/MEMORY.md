...
| Primitivos de UI (código, não cópia) | [`frontend/src/app/shared/ui/`](../../frontend/src/app/shared/ui/) — hoje `app-botao` e `app-campo` (`ui-01`) | pôr um botão ou um campo de formulário na tela |
