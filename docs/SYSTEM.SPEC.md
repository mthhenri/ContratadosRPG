...
| M6 | Gestão de Usuários & Papéis | Tipo global (NORMAL/ADMIN/TESTER), autorização, gestão do admin, acesso limitado a testers e impersonação administrativa auditável | backlog |
