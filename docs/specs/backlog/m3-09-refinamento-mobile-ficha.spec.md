...
> ⚠️ **SUPERSEDED — não implementar isolada.** Absorvida pela `m3-26-otimizacao-espaco-ficha.spec.md`
...
> colapsáveis, densidade por tokens) foram reenquadrados na **m3-26**. Mantida aqui só como
