...
> Atualizado após cada sessão de implementação. Última atualização: 2026-07-08 (**m2-13 —
...
(edição/exclusão de campanha — consome os endpoints `PUT`/`DELETE` da m2-04) e frontend **m2-13** (gestão
de membros — remover jogador / transferir mestre, consome a m2-10) **concluídos** (specs em
`docs/specs/done/`). Restam: **m2-14** (frontend de perfil/exclusão de conta — consome a m2-11) e
**m2-15** (refino visual da tela de campanhas).
**Próxima task: `m2-14` — frontend de perfil do usuário (alterar nome/login + excluir a própria conta).**
