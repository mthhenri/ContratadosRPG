...
> Atualizado após cada sessão de implementação. Última atualização: 2026-07-07 (**m2-10 —
...
**Próxima task: `M3` — Ficha de Jogador** (CRUD + cálculo automático via `shared/regras` + permissões +
tempo real). O milestone ainda está em `backlog` e precisa ser quebrado em tasks numeradas (`m3-01…`)
antes da implementação. **Antes de qualquer UI, ler `docs/design/DESIGN.md` e consumir os tokens de
