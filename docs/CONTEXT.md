...
> scroll lateral no mobile (sem overflow do body) e painel de mods rolando com fade na base. Spec `m1-20`
> em `done/`. **M1 fecha com 20 tasks.** Sessão anterior no mesmo dia: **refino mobile da
