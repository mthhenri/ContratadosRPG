...
"fechado" acima, dependendo de fichas já entregues pelo M3):** `m2-16` (fichas do membro na lista —
`docs/specs/done/m2-16-fichas-do-membro-na-lista.spec.md`) **concluída**. Resta **`m2-17`**
(`docs/specs/backlog/m2-17-redesenho-visual-campanhas.spec.md` — redesenho visual amplo de
`/painel`/`/painel/:id`, só apresentação, sem dado/schema novo), independente da fila do M3 acima.
