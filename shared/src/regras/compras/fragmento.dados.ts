...
/**
 * Dados tipados de Fragmentos (m3-35/m3-42/m3-63) — custo em Energia por módulo, o cardápio de
 * bônus do Potencializador "em um item", a Afinidade e o Preço de Sanidade do Consumo. Conferidos
 ...
 * vence (proibição #27).
 *
 * **Recorte (núcleo, decisão do autor):** o custo de Energia de adquirir/acoplar/remover, o bônus
 * "em um item" do Potencializador (as 5 opções da tabela, `m3-63`), a Afinidade e o Preço de
 * Sanidade do Consumo. Anomalia Biológica, Colapso, Redução de Módulo, Forja, os bônus "Consumido"
 * da tabela do Potencializador (concessão de +1 em testes/Defesa/dano do Corpo — sem catálogo/UI
 * nesta task, `m3-64`) e a tabela de bônus fixos do Construtor (arma/proteção por módulo, `m3-65`)
 * ficam de fora — specs futuras.
 */
