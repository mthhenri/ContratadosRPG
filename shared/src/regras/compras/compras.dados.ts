...
export const MODIFICACOES: Partial<Record<ItemCategoriaEnum, readonly ModificacaoDados[]>> = {
  ...
  [ItemCategoriaEnum.EXPLOSIVOS]: [
    ...
    {
      nome: 'Posicionável', empilhamentosIniciais: 1, empilhamentoMaximo: 5, bloqueia: ['Adesiva', 'Aerodinâmica', 'Corrosiva'],
      descricao: 'Instalável e ativável remotamente a 30m (Sentidos DT Intelecto para perceber). Extras: +2 DT e +5m/stack',
    },
  ...
  [ItemCategoriaEnum.MUNICOES]: [
    ...
    {
      nome: 'Instável', empilhamentosIniciais: 1, empilhamentoMaximo: 5, bloqueia: [],
      descricao: '+1D10 [Balístico]. Falhar: 10% de chance de reduzir 1 cena. Empilhamentos adicionais não aumentam a chance',
    },
  ...
  [ItemCategoriaEnum.ARMAZENAMENTO]: [
    ...
    {
      nome: 'Espaço Reservado', empilhamentosIniciais: 2, empilhamentoMaximo: 4, bloqueia: ['Compartimentos Extras'],
      descricao: 'Selecione um item Operacional ou Medicinal: a 2ª repetição não conta peso. Extras: +1 item desconsiderado', peso: 0,
    },
