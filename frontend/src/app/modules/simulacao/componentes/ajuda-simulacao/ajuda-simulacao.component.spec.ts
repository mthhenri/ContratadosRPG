...
import { AjudaSimulacao } from './ajuda-simulacao.component';
 ...
 */
describe('AjudaSimulacao', () => {
  async function montar(aba: AbaAjuda) {
    await TestBed.configureTestingModule({ imports: [AjudaSimulacao] }).compileComponents();
    const fixture = TestBed.createComponent(AjudaSimulacao);
