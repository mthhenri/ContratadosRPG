...
/**
 * Prova de que as 6 rotas lazy da simulacao resolvem, que o deep-link por rota funciona e
...
describe('Simulacao — roteamento', () => {
  ...
  async function navegar(url: string): Promise<HTMLElement> {
    TestBed.configureTestingModule({ providers: [provideRouter(simulacaoRoutes)] });
