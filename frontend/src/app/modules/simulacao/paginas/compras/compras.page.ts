...
/**
 * Aba "Compras" da simulacao (m1-10) — a mais pesada: configuração do agente, resumo de
...
@Component({
  ...
  imports: [ReactiveFormsModule, StepInput, AjudaSimulacao, Icone, OverflowFade, Tooltip],
