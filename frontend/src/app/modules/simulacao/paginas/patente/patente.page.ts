...
/**
 * Aba "Patentes" da simulacao (m1-08). Formulário reativo (Prestígio atual) reusando o
...
@Component({
  ...
  imports: [ReactiveFormsModule, StepInput, AjudaSimulacao, Tooltip],
  templateUrl: './patente.page.html',
  styleUrl: './patente.page.scss',
})
export class PatentePage {
  private readonly estadoAbas = inject(EstadoAbasSimulacaoService);
